  ...
  return (
    <div className="starMapPage relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white p-8">
        ...
        <p className="mb-8">
          Navigate through {exoplanets.length} exoplanets around {stars.length}{" "}
          nearby stars.
        </p>
        ...
        {selectedStar && (
          <div
            style={{
              ...
              right: "2rem",
              background:
                "linear-gradient(145deg, rgba(10,13,31,0.9), rgba(10,13,31,0.7))",
          ...
          >
            ...
            >
              <p>
                <strong>Distance:</strong> {selectedStar.distance} parsecs
              </p>
              <p>
                <strong>Planets:</strong>{" "}
                {selectedStar.planet_count || "Unknown"}
              </p>
              <p>
                <strong>Type:</strong> {selectedStar.stellar_type || "Unknown"}
              </p>
              <p>
                <strong>Coordinates:</strong> RA {selectedStar.ra}°, Dec{" "}
                {selectedStar.dec}°
              </p>
            </div>
          </div>
